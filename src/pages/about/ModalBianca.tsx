  ...
  return (
    <>
      ...
      <Popup
        trigger={
          <img
            src="https://i.imgur.com/3gH6LBw.png"
            alt="Team Member"
        ...
        <div className="bg-white rounded-lg p-6 max-w-sm mx-auto shadow-xl">
          <div className="flex flex-col items-center">
            ...
            <p className="text-gray-600 text-center mb-6 text-sm">
              Desenvolvedora FullStack, apaixonada por tecnologia e por criar
              soluções inovadoras que atendam as necessidades dos usuários.
            </p>

            <div className="flex space-x-4">
              <a
                href="https://github.com/Bianncajs"
                target="_blank"
              ...
              <a
                href="https://www.linkedin.com/in/biancajesuss/"
                target="_blank"
                rel="noopener noreferrer"
                className="p-2 bg-gray-100 rounded-full hover:bg-gray-200 transition-colors"
              >
